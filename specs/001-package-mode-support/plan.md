...
├── plan.md              # This file
├── research.md          # Phase 0: bootc detection mechanism, update path analysis
├── data-model.md        # Phase 1: device status schema extension
├── quickstart.md        # Phase 1: package-mode installation guide
├── contracts/           # Phase 1: device status API updates
│   └── device-status.yaml
...
│   │   └── packagemode_ubuntu_test.go # NEW: Ubuntu package-mode tests
│   └── fixtures/
│       ├── rhel9-runner/              # NEW: RHEL test infrastructure
│       └── ubuntu22-runner/           # NEW: Ubuntu test infrastructure
├── deploy/packaging/                  # Packaging (EXISTING, document usage)
│   ├── rpm/                           # RPM spec files for RHEL
│   └── deb/                           # .deb package metadata (assumed available)
└── docs/                              # Documentation (NEW)
    └── user/installing/
        ├── installing-agent-rhel-package-mode.md    # NEW
